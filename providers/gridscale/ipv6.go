...
func (g IPv6Generator) createResources(ipAddrList []gsclient.IP) []terraformutils.Resource {
	var resources []terraformutils.Resource
	for idx, ipAddr := range ipAddrList {
		if ipAddr.Properties.Family != 6 {
			continue
		}
...
func (g *IPv6Generator) InitResources() error {
